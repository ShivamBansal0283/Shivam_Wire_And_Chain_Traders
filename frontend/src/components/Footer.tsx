        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-white font-bold text-xl">{COMPANY_INFO.name}</span>
            </div>
            ...
            <div className="space-y-2">
              <p className="text-slate-300">
                📍 {COMPANY_INFO.address || 'Agra, Uttar Pradesh, India'}
              </p>
              <p className="text-slate-300">
                📞 {COMPANY_INFO.phone}
              </p>
              <p className="text-slate-300">
                ✉️ <a href={`mailto:${COMPANY_INFO.email}`} className="underline">{COMPANY_INFO.email}</a>
              </p>
              <p className="text-slate-300">
