        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              About <span className="text-yellow-400">Shivam Wires</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-lg text-slate-600 leading-relaxed">
                <p>
                  Founded in the industrial heart of Agra, Uttar Pradesh, Shivam Wires began 
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-slate-600 leading-relaxed italic mb-4">
                  "When I started Shivam Wires four decades ago, my vision was simple - 
                ...
                <div>
                  <p className="font-semibold text-slate-800">Shri Ram Kumar Gupta</p>
                  <p className="text-slate-500">Founder & Managing Director</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-2 text-slate-600">
                <p><strong>Address:</strong> Industrial Area, Agra, UP 282001</p>
                <p><strong>Phone:</strong> +91 XXXXXXXXXX</p>
                <p><strong>Email:</strong> info@shivamwires.com</p>
              </div>
            </div>
          </div>
        </div>
