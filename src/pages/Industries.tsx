...
const industries = [
  {
    ...
    testimonial: {
      ...
      company: "Comfort Sleep Industries",
  ...
  },
  {
    ...
    testimonial: {
      text: "The quality of wire from Shivam Wires ensures our brushes maintain their shape and effectiveness even under heavy use.",
  ...
  },
  {
    ...
    testimonial: {
      text: "For critical infrastructure projects, we rely on Shivam Wires for their consistent quality and timely delivery.",
  ...
  },
  {
    ...
    testimonial: {
      text: "Our rope products have gained international recognition, thanks to the reliable wire quality from Shivam Wires.",
